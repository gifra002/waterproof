...
'*****************************************************************
'If DEMO version remove the following two lines
...
GoTo 100
        ...
        Data1.RecordSource = "Select * From [HELP]"
        
        Libero_1.Text = Data1.Recordset.Libero_1
        Libero_2.Text = Data1.Recordset.Libero_2
        Libero_3.Text = Data1.Recordset.Libero_3
        RRR1 = Libero_3.Text
        
        Randomize                           ' Initialize random-number generator.
        RRR = Int((899 * Rnd) + 100)        ' Generate random value between 1 and 6.
        Libero_3 = RRR
        ...
        'CONTO PROVE
            ...
            'DECODIFICA RRR1
                ...
                For i = 1 To pSize Step 3
                    j = j + 1
                    RND1(i) = Chr(Mid$(RRR1, i, 2))
                    RND1_1 = RND1(i)
                    RND1_2 = RND1_2 & RND1_1
                    RND1_1 = 0
                    DECOD_RND = RND1_2
                Next i
                RRR1 = Val(RND1_2)
            'DECODIFICA VOLTE
                ...
                For i = 1 To pSize Step 3
                    j = j + 1
                    CONTO(i) = Chr(Mid$(VOLTE, i, 2))
                    Conto1 = CONTO(i)
                    Conto2 = Conto2 & Conto1
                    Conto1 = 0
                    DECOD_CONTO = Conto2
                Next i
                VOLTA = Conto2 - RRR1
                TTT = Val(VOLTA)
                VOLTA = Val(VOLTA) + RRR + 1
                Libero1 = Libero_1
                If Conto2 - RRR1 <> Libero_1 Or VOLTA - RRR < 1 Then
                ...
                If VOLTA - RRR > 11 Then
                    Label8.Caption = "Attention: You must enter the unlock password!"
                    Label8.Visible = True
                    MsgBox ("Attention, you passed trial runs! You should order the unlocked version of WaterProof HX")
                End If
                Libero_1.Text = VOLTA - RRR
        '        Call CONTROLLO
            ...
            'CODIFICA VOLTE 1
                ...
                For i = 1 To xSize
                    ...
                    ElseIf let1 > 27 Then
                        let2 = 27
                    End If
                    VOLTE_1 = Left$(Numero(i), 2) & Mid$(ALFABETO, let1, 1)
                    VOLTE_2 = VOLTE_2 & VOLTE_1
                    VOLTE_1_1 = 0
                Next i
                Libero_2.Text = VOLTE_2
            'CODIFICA RND
                xSize = Len(RRR)
                ALFABETO = "ABCDEFGHIJKLMNOPQRSTUVWXYZ._"
                ReDim az1(xSize), Numero(xSize)
                For i = 1 To xSize
                    ...
                    ElseIf let1 > 27 Then
                        let2 = 27
                    End If
                    RRR_1 = Left$(Numero(i), 2) & Mid$(ALFABETO, let1, 1)
                    RRR_2 = RRR_2 & RRR_1
                    RRR_1_1 = 0
                Next i
                Libero_3.Text = RRR_2
...
GoTo 200
                ...
                If temp = "locked" Then
                    ...
                    If Oggi >= NewDate Then
                        Msg = MsgBox("The program passed the expiring date. You should order the unlocked version of WaterProof HX")
...
'Test for trial or unlock key
                If txtPassword.Text = PASS_X And Libero_1 < 10 Then
                    SaveSetting APP_NAME, SECTION_NAME, KEY_NAME, "locked"
                    Unlocked = False
                    MsgBox "Valid trial password.", , "Enter"
                    OK = True
                    Call CONTROLLO
                    Me.Hide
                ElseIf txtPassword.Text = PASS_X And Libero_1 = 10 Then
                    Label8.Caption = "Attention: this is the last trial!"
                    Label8.Visible = True
                    MsgBox ("You completed the allowed trials. You should order the unlocked version. If you run the program next time you should have the unlock password, otherwise you cannot run it anymore.")
                    SaveSetting APP_NAME, SECTION_NAME, KEY_NAME, "locked"
                    Unlocked = False
                    MsgBox "Valid trial password.", , "Enter"
                    OK = True
                    Call CONTROLLO
                    Me.Hide
                ElseIf txtPassword.Text = PASS_X And Libero_1 > 11 Then
                    Label8.Caption = "Attention: You must enter the unlock password!"
                    Label8.Visible = True
                    MsgBox ("You must enter the unlock password, otherwise you cannot run the program anymore!.")
