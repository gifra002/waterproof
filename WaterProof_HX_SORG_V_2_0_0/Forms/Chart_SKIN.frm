...
Begin VB.Form Chart_SKIN 
   Caption         =   "WaterProof HX - Heat Exchangers Performance Monitoring - Skin temperature trend chart "
   ClientHeight    =   10005
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   14700
   ...
   Begin MSComctlLib.TabStrip TabStrip1 
      ...
      EndProperty
   End
   Begin MSChart20Lib.MSChart MSChart_SKIN 
      Height          =   6555
      Left            =   120
      OleObjectBlob   =   "Chart_SKIN.frx":0000
      TabIndex        =   0
      Top             =   1200
      Width           =   11295
   End
            ...
            If UUU1 = UUU2 Then
                ...
                ETX(www) = Data1.Recordset.date_test
                    If ETX(www) >= INIZIO And ETX(www) <= FINE Then
                        XXX = XXX + 1
                        SY(XXX, 1) = Data1.Recordset.SKIN_TEMP
