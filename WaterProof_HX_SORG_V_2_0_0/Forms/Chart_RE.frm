...
Begin VB.Form Chart_RE 
   Caption         =   "WaterProof HX - Heat Exchangers Performance Monitoring -Tube-side Reynolds Number trend chart"
   ClientHeight    =   9720
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   14895
   ...
   Begin MSComctlLib.TabStrip TabStrip1 
      ...
      EndProperty
   End
   Begin MSChart20Lib.MSChart MSChart_RE 
      Height          =   6555
      Left            =   120
      OleObjectBlob   =   "Chart_RE.frx":0000
      TabIndex        =   0
      Top             =   1200
      Width           =   11415
   End
...
Private Sub Spin_MAX_Change()
    MM2 = Spin_MAX.Value * 100
    Text_MAX.Text = Spin_MAX * 100
    Call chart
End Sub
Private Sub Spin_MIN_Change()
    Min = Spin_MIN.Value * 100
    Text_MIN.Text = Spin_MIN * 100
    Call chart
End Sub
            ...
            CONTO = Rs1.RecordCount
                ...
                ETX(www) = Data1.Recordset.date_test
                    If ETX(www) >= INIZIO And ETX(www) <= FINE Then
                        XXX = XXX + 1
                        SY(XXX, 1) = Data1.Recordset.TUBES_REYNOLDS
        ...
        .RowCount = 1
             With MSChart_RE.Plot
              ...
              If Check_MAX = Unchecked Then
                    MM2 = Int(MM2 / 50000 + 1) * 50000
                    Min = 0
                    Spin_MAX.Value = MM2 / 100
                    Spin_MIN.Value = Min / 100
                Else
                    MM2 = Spin_MAX * 100
                    Min = Spin_MIN * 100
              End If
