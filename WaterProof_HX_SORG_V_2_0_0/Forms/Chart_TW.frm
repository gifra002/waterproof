...
Begin VB.Form Chart_TW 
   Caption         =   "WaterProof HX - Heat Exchangers Performance Monitoring - Tube-side Inlet / Outlet Water temperatures trend chart"
   ClientHeight    =   9720
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   14715
   ...
   Begin MSComctlLib.TabStrip TabStrip1 
      ...
      EndProperty
   End
   Begin MSChart20Lib.MSChart MSChart_TW 
      Height          =   6555
      Left            =   120
      OleObjectBlob   =   "Chart_TW.frx":0000
      TabIndex        =   0
      Top             =   1200
      Width           =   11415
   End
            ...
            CONTO = Rs1.RecordCount
                ...
                ETX(www) = Data1.Recordset.date_test
                    If ETX(www) >= INIZIO And ETX(www) <= FINE Then
                        XXX = XXX + 1
                        SY(XXX, 1) = Data1.Recordset.TUBES_TEMP_IN
                        SY(XXX, 2) = Data1.Recordset.TUBES_TEMP_OUT
