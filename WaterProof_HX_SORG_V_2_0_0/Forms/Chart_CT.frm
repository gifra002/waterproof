...
Begin VB.Form Chart_CT 
   Caption         =   "WaterProof HX - Heat Exchangers Performance Monitoring- Condensing temperature trend chart "
   ClientHeight    =   9720
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   14745
   ...
   Begin MSComctlLib.TabStrip TabStrip1 
      ...
      EndProperty
   End
   Begin MSChart20Lib.MSChart MSChart_CT 
      Height          =   6555
      Left            =   360
      OleObjectBlob   =   "Chart_CT.frx":0000
      TabIndex        =   0
      Top             =   660
      Width           =   11415
   End
            ...
            CONTO = Rs1.RecordCount
                ...
                ETX(www) = Data1.Recordset.date_test
                    If ETX(www) >= INIZIO And ETX(www) <= FINE Then
                        XXX = XXX + 1
                        SY(XXX, 1) = Data1.Recordset.Temp_COND
