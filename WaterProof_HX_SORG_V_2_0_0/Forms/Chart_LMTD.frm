...
Begin VB.Form Chart_LMTD 
   Caption         =   "WaterProof HX - Heat Exchangers Performance Monitoring - LMTD trend chart"
   ClientHeight    =   9720
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   14730
   ...
   Begin MSComctlLib.TabStrip TabStrip1 
      ...
      EndProperty
   End
   Begin MSChart20Lib.MSChart MSChart_LMTD 
      Height          =   6555
      Left            =   120
      OleObjectBlob   =   "Chart_LMTD.frx":0000
      TabIndex        =   0
      Top             =   1200
      Width           =   11415
   End
